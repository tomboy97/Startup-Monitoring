<?php
	...
	if(isset($_POST) & !empty($_POST))
	{
		...
		if($password == $cpassword){
			$usernamesql = "SELECT * FROM `lib_user` WHERE name='$name'";
			...
			/*$emailsql = "SELECT * FROM `lib_user` WHERE email='$email'";
			...
			$sql = "INSERT INTO `lib_user` (name, comp_name, password, cpassword) VALUES 
				('$name', '$comp_name', '$password', '$cpassword')";
