<?php
	...
	if(isset($_POST) & !empty($_POST))
	{
		...
		echo $sql = "SELECT * FROM `mentor` WHERE name = '$name' AND password = '$password'";
		...
		{
			header('Location: mentor_profile.html');
		}	
	}
?>
...
<div class="col-md-4">
<div class="form_main">
            <h4 class="heading"><strong>Mentor Login </strong> Form <span></span></h4>
            <div class="form">
            <form action="" method="post" id="contactFrm">
                <input type="text" required="" placeholder="Enter Name" name="name" class="txt">
                <input type="password" required="" placeholder="Enter Password" name="password" class="txt">
