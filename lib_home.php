...
<br><br>
  ...
  <div class="container">
    ...
    <li class="nav-item">
      <a class="nav-link" href="books.php">Categories</a>
    </li>
    <li class="nav-item">
	...
	<li class="nav-item">
      <a class="nav-link" href="reg_stu.php">Registered students</a>
    </li>
  </ul>
    <h2>Library management will allow the users to register and get the facilities provided by the management cell.</h2>
  </div>  
  <!--Start lib form-->
